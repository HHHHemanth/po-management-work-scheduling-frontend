...
export function ContainerScroll({ children, style, className, ...props }) {
...
export function CardsContainer({ children, className, ...props }) {
...
export const CardTransformed = React.forwardRef(function CardTransformed(
  {
    arrayLength,
    index,
    incrementY = 10,
...
export const ReviewStars = React.forwardRef(function ReviewStars(
  { rating, maxRating = 5, className, ...props },
  ref
) {
